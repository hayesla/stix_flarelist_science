...
flare_list = READ_CSV('stix_flarelist_with_files_1000_for_idlinput.csv')

; define the file to save to
openw, 1, './flarelist_locations_idloutput_416keV_1000counts_40s.csv'
...
FOR i = 0,  n_elements(flare_list.FIELD01) DO BEGIN; n_elements(flare_list.FIELD01)loop through all rows in data structure
    ...
    IF Error_status NE 0 THEN BEGIN
      ...
      openw, 1, './errors_idlout_416keV_1000counts_40s.csv', /append
    ...
    ; save the output
    openw, 1, './flarelist_locations_idloutput_416keV_1000counts_40s.csv', /append
