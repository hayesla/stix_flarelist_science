...
;          May 2023, Collier H., adapted code for flare list
;
; CONTACT:
;   paolo.massa@wku.edu
;-
...
pro stx_estimate_flare_location_flare_list, path_sci_file, time_range, aux_data, flare_loc=flare_loc, path_bkg_file=path_bkg_file, $
  ...
  ;vis_fwdfit_pso_map = stx_vis_fwdfit_pso(configuration,vis,aux_data,fitsigmas=fitsigmasout_pso,/uncertainty)
