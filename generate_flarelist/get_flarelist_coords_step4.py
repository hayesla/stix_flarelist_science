...
import astrospice
from flarelist_coord_utils import get_rsun_obs, is_visible


# read in the flarelist from step 4
full_flarelist = pd.read_csv("full_flarelist_with_locations_1000_416keV.csv")
# only choose flares that pass the backprojection map test
